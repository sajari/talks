...
func ClueAddTerm(builder *flatbuffers.Builder, Term flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(Term), 0)
}
func ClueAddIntro(builder *flatbuffers.Builder, Intro flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(Intro), 0)
}
func ClueAddPotency(builder *flatbuffers.Builder, Potency float32) {
	builder.PrependFloat32Slot(2, Potency, 0)
}
